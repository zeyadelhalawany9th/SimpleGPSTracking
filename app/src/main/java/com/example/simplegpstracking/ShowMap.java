...
import com.example.simplegpstracking.databinding.ActivityShowMapBinding;
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(@NonNull Marker marker) {
                ...
                Toast.makeText(ShowMap.this, "Marker "+"\n"+ marker.getTitle()+ " "+"\n"+savedLocationss.get(savedLocationss.size()-1)+ "\n" +" has been clicked "+marker.getTag()+" times", Toast.LENGTH_SHORT).show();
                return false;
            }
        });
